...
aY.each(function(){if(this.nodeType!==1||this.nodeName!==(a0[aZ]&&a0[aZ].nodeName)){return
}var a6=a.data(a0[aZ++]),a5=a.data(this,a6),a3=a6&&a6.events;
if(a3){delete a5.handle;
a5.events={};
for(var a4 in a3){for(var a2=0,a1=a3[a4].length;
a2<a1;
a2++){a.event.add(this,a4,a3[a4][a2],a3[a4][a2].data)
}}}})
